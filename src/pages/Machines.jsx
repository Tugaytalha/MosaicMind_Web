    ...
    if (isLoading) {
        ...
        return (
            ...
            />
                        ...
                        <Machine name="Machine 1" status={machines['isOnline1'] === 1 ? 'Online' : 'Offline'} updates={machines['r1-update-c']} positiveFeedback={machines['r1-correct-c']} negativeFeedback={machines['r1-fail-c']} successRate = {calculateSuccessRate(machines['r1-correct-c'], machines['r1-fail-c'])}/>
                        <Machine name="Machine 2" status={machines['isOnline2'] === 1 ? 'Online' : 'Offline'} updates={machines['r2-update-c']} positiveFeedback={machines['r2-correct-c']} negativeFeedback={machines['r2-fail-c']} successRate = {calculateSuccessRate(machines['r2-correct-c'], machines['r2-fail-c'])}/>
                        <Machine name="Machine 3" status={machines['isOnline3'] === 1 ? 'Online' : 'Offline'} updates={machines['r3-update-c']} positiveFeedback={machines['r3-correct-c']} negativeFeedback={machines['r3-fail-c']} successRate = {calculateSuccessRate(machines['r3-correct-c'], machines['r3-fail-c'])}/>
